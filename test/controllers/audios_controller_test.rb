...
class AudiosControllerTest < ActionController::TestCase
  ...
  test "should create audio" do
    assert_difference('Audio.count') do
      post :create, audio: { capture: @audio.capture, reference: @audio.reference, title: @audio.title, uniqid: @audio.uniqid, url: @audio.url }
    end
  ...
  test "should update audio" do
    patch :update, id: @audio, audio: { capture: @audio.capture, reference: @audio.reference, title: @audio.title, uniqid: @audio.uniqid, url: @audio.url }
    assert_redirected_to audio_path(assigns(:audio))
  end
